...
plugins=(git archlinux colored-man-pages command-not-found dircycle dirhistory docker docker-compose jira npm python pip tmux vi-mode virtualenv web-search z)
