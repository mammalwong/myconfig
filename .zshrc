...
plugins=(git archlinux bgnotify colored-man-pages command-not-found docker docker-compose jira npm python pip tmux vi-mode virtualenv virtualenvwrapper web-search fasd zsh-navigation-tools zsh-autosuggestions zsh-syntax-highlighting)
